...
from meta_aggregation_api.providers.one_inch_v5.one_inch_provider import LIMIT_ORDER_VERSION
...
@pytest.mark.asyncio()
@patch('providers.one_inch_v5.OneInchProviderV5.get_response', new_callable=AsyncMock)

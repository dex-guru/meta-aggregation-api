...
@market_route.get('/{chain_id}/price', response_model=MetaPriceModel, responses=responses)
@market_route.get('/{chain_id}/price/', response_model=MetaPriceModel,
...
@market_route.get('/{chain_id}/price/all', response_model=List[MetaPriceModel],
                responses=responses)
@market_route.get('/{chain_id}/price/all/', include_in_schema=False,
...
@market_route.get('/{chain_id}/quote', response_model=ProviderQuoteResponse,
